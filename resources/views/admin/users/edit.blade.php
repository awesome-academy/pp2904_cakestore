...
<div class="m-portlet m-portlet--tab">
    ...
    <!--begin::Form-->
    <form class="m-form m-form--fit m-form--label-align-right" method="post" action="/manager/users/{{$user->id}}">
        @method('PUT')
        @csrf
        <div class="m-portlet__body">
            ...
            <div class="form-group m-form__group row">
                ...
                <div class="col-lg-6 col-md-9 col-sm-12">
                    <input type="password" name="password" value="{{$user->password}}" class="form-control m-input" id="exampleInputEmail1">
                </div>
            </div>
        </div>
